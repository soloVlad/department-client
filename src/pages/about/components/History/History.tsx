	...
	return (
		<TitledSection id="history" title="История">
			<Text fz={18}>
				...
				<br />
				<br />
				Первыми сотрудниками кафедры были Монастырный П., Шешко M., Демидович
				Н., Мастяница В., Плащинская А., Радаева В., Азаров А., Листопад Г.,
				Расолько Г., Черенкевич З. Позже к работе на кафедре присоединились
				Пальцев А., Феденко Н., Мелешко И., Якименко Т. и др.
				<br />
				<br />С момента основания до 2002 года кафедру возглавлял профессор Петр
				Ильич Монастырный.
			</Text>
		</TitledSection>
	);
